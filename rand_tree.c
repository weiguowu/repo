/*
*There is a tree of nodes, each node contains a random integer number
*and a block of memory of random size. The number of child nodes for 
*any parent nodes is random, and the depth of the tree is also a random
*number. All the random numbers should be generated by random().
*	Author:Wei Guowu, Date:01/23 2016
*/
#include <stdio.h>
#include <stdlib.h>
struct node_t{
